...
urlpatterns += patterns(view_location,
    ...
    url(r'^about/', include(patterns(view_location,
        ...
        url(r'^member/edit/(?P<memberID>[\.\w-]+)$', 'members', name='memberForm'),
        url(r'^(?P<contactType>[\.\w-]+)/edit/$', 'contacts', name='contactForm'),
    ))),
    url(r'^music/', include(patterns(view_location,
        url(r'^album/add/$', 'AddEditAlbum', name='albumForm'),
        url(r'^album/(?P<albumID>[\.\w-]+)/edit/$', 'AddEditAlbum', name='editAlbumForm'),
        url(r'^album/(?P<albumID>[\.\w-]+)/tracks/add/$', 'AddEditTracks', name='tracksForm'),
