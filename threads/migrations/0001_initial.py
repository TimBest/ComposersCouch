...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Thread'
        db.create_table('messages_thread', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('latest_msg', self.gf('django.db.models.fields.related.ForeignKey')(related_name='thread_latest', to=orm['messages.Message'])),
        ))
        db.send_create_signal('messages', ['Thread'])

        # Adding M2M table for field all_msgs on 'Thread'
        db.create_table('messages_thread_all_msgs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('thread', models.ForeignKey(orm['messages.thread'], null=False)),
            ('message', models.ForeignKey(orm['messages.message'], null=False))
        ))
        db.create_unique('messages_thread_all_msgs', ['thread_id', 'message_id'])

        # Adding model 'Participant'
        db.create_table('messages_participant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thread', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participants', to=orm['messages.Thread'])),
        ...
        db.send_create_signal('messages', ['Participant'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('messages_thread')

        # Removing M2M table for field all_msgs on 'Thread'
        db.delete_table('messages_thread_all_msgs')

        # Deleting model 'Participant'
        db.delete_table('messages_participant')
