...
if DEVELOPMENT:
    ...
    ALLOWED_HOSTS += ['composerscouch.elasticbeanstalk.com']#['djangosite-env-ntjden2apj.elasticbeanstalk.com']
    POSTGIS_VERSION = (2, 1, 1)
    STREAM_REDIS_CONFIG = {
        'default': {
            'host': 'aws-my-163kxzchoaczp.og7bpd.0001.use1.cache.amazonaws.com',#'aws-my-iiivslcgwpn1.og7bpd.0001.use1.cache.amazonaws.com',
            'port': 6379,
