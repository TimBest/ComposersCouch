...
PIPELINE_JS = {
    'scripts': {
        'source_filenames': (
            ...
            'js/includes/autocomplete_light/addanother.js',
            'js/includes/autocomplete_light/autocomplete.js',
            'js/includes/autocomplete_light/text_widget.js',
            'js/includes/autocomplete_light/widget.js',
