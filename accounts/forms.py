        ...
        "<div class='profile-type form-group' style='display:none;'>\
          <div class='btn-group btn-group-justified' role='group'>\
            <div class='btn-group' role='group'>\
              <button type='button' id='f' class='btn btn-default btn-border-right-none'><span class='hidden-xs fa fa-users'></span> Fan</button>\
            </div><div class='btn-group' role='group'>\
              <button type='button' id='m' class='btn btn-default btn-border-right-none'><span class='hidden-xs fa fa-music'></span> Artist</button>\
            </div><div class='btn-group' role='group'>\
              <button type='button' id='v' class='btn btn-default'><span class='hidden-xs fa fa-ticket'></span> Venue</button>\
        </div></div></div>"
    )
)
